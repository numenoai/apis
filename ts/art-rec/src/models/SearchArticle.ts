...
/**
 * An Article appearing in a search result.
 * @export
...
export interface SearchArticle {
  ...
  publishDate?: Date
  /**
   * A score indicating the relevancy of the Article in the context of this search query.
   * @type {number}
   * @memberof SearchArticle
   */
  score?: number
...
export function SearchArticleFromJSONTyped(
  json: any,
...
export function SearchArticleToJSON(json: any): SearchArticle {
  return SearchArticleToJSONTyped(json, false)
}

export function SearchArticleToJSONTyped(
  value?: SearchArticle | null,
